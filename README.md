...
[Minttu](https://gitlab.com/minttu.dev) are proposed, discussed, and recorded.

## What is Minttu?

Minttu is an open source classless-first CSS design system and web toolkit built
for the modern web. It provides fluid typography with musical interval ratios,
adaptive color systems with light and dark themes, responsive layout primitives,
and progressively enhanced components — all without requiring classes for
beautiful, accessible HTML.

The name is Finnish for “mint” — fresh, clean, and naturally pleasant. A design
system should feel effortless and invisible, enhancing content through careful
typographic and spatial relationships rather than imposed decoration.
...
- **Decisions** capture internal technical and organisational choices — how Minttu is built, structured, and maintained.

- **Comments** handle community-facing proposals — changes
  to public interfaces, features, behaviour, and integration patterns that
  affect how people use Minttu.
...
Proposals in this repository may affect any part of the Minttu ecosystem:

**Tokens**
- Design token system (colors, spacing, elevation, shape, motion)
- CSS custom properties with semantic naming
- Light and dark theme token sets

**Scale**
- Fluid type scale with musical interval ratios
- Responsive scaling between viewport bounds
- Spacing scale derived from typography

**Base**
- CSS reset and sensible defaults
- Classless base styling for all HTML elements
- Accessibility foundations (focus styles, reduced motion, contrast)

**Layout**
- Grid system and containers
- Responsive utilities and breakpoint tokens
- Spacing classes and spatial relationships

**Components**
- Buttons, cards, chips, navigation, drawers, modals
- Form elements and inputs
- Progressive enhancement via classes

**Patterns**
- Page templates and complex compositions
- Responsive layout patterns
- Common application patterns

**Motion**
- Transitions and animations
- Micro-interactions and state changes
- Scroll-driven effects

**Web components**
- Custom elements as progressive enhancement
- Preact islands and shadow DOM patterns
- Interactive component layer

**Tooling**
- Vite plugin for CSS import resolution
- Fresh extensions for Deno applications
- Build system (esbuild via Deno)
- Documentation site

**Infrastructure**
- Polo deployment system
- Edge proxy (Fastly Compute)
- DNS, storage, and CDN configuration
...
Minttu is governed by the [Omnifi Foundation](https://omnifi.foundation), a
